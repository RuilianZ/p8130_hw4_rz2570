...
Patients with pedestrian crash have the highest PSTD score with a average of 37.875, patients with bicycle crash have a average PTSD score of 32.500, and patients in bicycle group have a average PTSD score of 23.429. Patients with pedestrian crash also has the highest range (14) and variance (29.554) compared to the other two groups. Based on a type I error of 0.01, the average of PTSD score across different crash type are significantly different, and we found that the average score of each two groups are pairwise different. 
